...
% TODO Add your title
\title{Manipulability Optimization and Obstacle Avoidance in Human-Robot Joint Collaboration}
%\subtitle{bla bla bla}

% TODO Add name of the authors
\studentA{Tobias Ulrich}
%\studentB{Student 2}

% TODO Add name of the supervisors
\supervisionA{Prof. Jonathan Kelly}
%\supervisionB{Professor Marco Hutter}
